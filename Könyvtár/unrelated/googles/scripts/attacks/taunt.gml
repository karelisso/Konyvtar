...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("VoiceMDefeat13"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_LENGTH, 23);
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_LENGTH, 27);
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, sound_get("VoiceMChance03"));
