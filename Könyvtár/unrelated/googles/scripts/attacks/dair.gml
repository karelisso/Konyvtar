...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("ChargeShotQuick"));
...
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 295);
...
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, Inksplode);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("critz"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("ShotExplosionLight00"));